...
const FavouritePlaceCard = (props) => {
  const {
    id,
    preview,
    price,
  ...
  return (
    <article className={`favorites__card place-card`}>
      ...
      <div className="favorites__image-wrapper place-card__image-wrapper">
        <Link to={`/offer/${id}`}>
          <img className="place-card__image" src={preview} width="150" height="120" alt="Place image"/>
        </Link>
      </div>
...
FavouritePlaceCard.propTypes = placeCardProps;
